...
def get_premium_plans_keyboard():
    keyboard = []
    keyboard.append([
        InlineKeyboardButton("15 Min - ₹29", callback_data="plan_15min"),
        InlineKeyboardButton("30 Min - ₹49", callback_data="plan_30min")
    ])
    keyboard.append([
        InlineKeyboardButton("1 Hour - ₹79", callback_data="plan_1hour"),
        InlineKeyboardButton("4 Hours - ₹149", callback_data="plan_4hours")
    ])
    keyboard.append([
        InlineKeyboardButton("24 Hours - ₹299", callback_data="plan_24hours"),
        InlineKeyboardButton("3 Days - ₹499", callback_data="plan_3days")
    ])
    keyboard.append([
        InlineKeyboardButton("7 Days - ₹799", callback_data="plan_7days"),
        InlineKeyboardButton("15 Days - ₹1299", callback_data="plan_15days")
    ])
    keyboard.append([
        InlineKeyboardButton("30 Days - ₹1999", callback_data="plan_30days")
    ])
